...
func PlacesSearchResults(data []models.WorldCities) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<ul class=\"appearance-none outline-none animate-results origin-top z-10 absolute top-12 left-0 w-full h-48 shadow rounded-lg bg-white border border-slate-300 transition duration-300 overflow-x-hidden overflow-y-auto scrollbar-thin scrollbar-track-action-light/30 scrollbar-thumb-action focus:ring-2 focus:ring-slate-300 md:w-10/12 lg:w-8/12 xl:w-7/12\" data-show=\"$showSearchResults\" id=\"searchResults\" tabindex=\"0\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for _, record := range data {
			...
			templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinURLErrs("/" + record.Lat + "/" + record.Lng)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/placesSearch.templ`, Line: 54, Col: 47}
			}
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs("evt.preventDefault();@get('/" + record.Lat + "/" + record.Lng + "')")
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/placesSearch.templ`, Line: 55, Col: 90}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/placesSearch.templ`, Line: 57, Col: 124}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/placesSearch.templ`, Line: 58, Col: 126}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/placesSearch.templ`, Line: 59, Col: 130}
			}
