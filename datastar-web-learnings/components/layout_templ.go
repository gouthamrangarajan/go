...
func layout(config models.FirebaseAuthConfig) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.ResolveAttributeValue(`{ _showLogin: false,_showLoginButton:false,_showAddVideoButton:false,
		...
		templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.ResolveAttributeValue(` window.initializeFirebaseApp ? 
								window.initializeFirebaseApp({apiKey:$_firebaseApiKey,authDomain:$_firebaseAuthDomain})
									:
								null`)
		if templ_7745c5c3_Err != nil {
